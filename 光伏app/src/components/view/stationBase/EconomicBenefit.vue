...
export default {
  ...
  mounted() {
  this.getTimePowerGeneration("/AppApi/Base/GetComponentCosts");  
  },
  methods: {
     getTimePowerGeneration(url) {
        ...
        that.$fetch(url).then(res => {
            ...
            // seriesData[0].name =batchdata.componentName
            seriesData[0].data =batchdata.componentCost
            // seriesData[1].name =batchdata.systemCostName
            seriesData[1].data =batchdata.systemCost
