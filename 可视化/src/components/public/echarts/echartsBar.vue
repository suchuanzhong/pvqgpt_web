  ...
  export default {
    ...
    methods: {
      ...
      initBg(option) {
        ...
        let maxDatas = JSON.parse(JSON.stringify(this.axisData)).splice(0,6).map(value => {
          return maxData[0]
        });
        ...
        if(yAxisIndex==1){
          ...
          let maxDatasIndex =JSON.parse(JSON.stringify(this.axisData)).splice(0,6).map(value => {
