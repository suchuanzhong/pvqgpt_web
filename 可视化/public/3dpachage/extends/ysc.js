...
(function (window,undefined) {
    ...
    function addCircleRipple(viewer,data){
        var r1=data.minR,r2=data.minR,r3=data.minR,r4=data.minR;
        ...
        if(data.addEntity){
            ...
            viewer.entities.add({
                ...
                ellipse : {
                    ...
                    material:"3dpachage/Cesium/Widgets/Images/base/circle2.png",
            ...
            viewer.entities.add({
                ...
                ellipse : {
                    ...
                    material:"3dpachage/Cesium/Widgets/Images/base/circle1.png",
