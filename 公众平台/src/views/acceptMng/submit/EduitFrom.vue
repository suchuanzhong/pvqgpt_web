          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="施工单位工程安全项程序文件：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[13].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="监理单位工程安全项程序文件：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[14].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="调试单位工程安全项程序文件：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[15].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="运行单位工程安全项程序文件：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[16].dataValue">{{
        ...
        <el-form :size="size" label-width="400px" class="section2">
          <el-row :gutter="20">
            <el-col :span="24">
              ...
              >
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[17].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="施工设计总说明：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[18].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="对组件、逆变器等设备到货验收记录：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[19].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="质量监督检查意见：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[20].dataValue">{{
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="检验批、分项、分部(子分部)和单位(子单位)：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[21].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="工程质量验评记录：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[22].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="隐蔽工程验收记录：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[23].dataValue">{{
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="调试大纲及项目划分：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[24].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="调试报告：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[25].dataValue">{{
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <el-form-item label="林光互补专项验收意见（或阶段性成果）：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[26].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="电网接入验收报告（或阶段性成果）：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[27].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="项目用地验收意见（或阶段性成果）：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[28].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="环保验收意见（或阶段性成果）：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[29].dataValue">{{
            ...
            <el-col :span="24">
              <el-form-item label="消防与安全验收意见（或阶段性成果）：">
                <div class="upload-wrap">
                  <span v-if="dataFrom.dataList[30].dataValue">{{
...
export default {
  ...
  created() {
    // this.upconfig.uploadurl = commonURL + "ManagerApi/BisProjectqualityreport/upload";
     this.getcommonURL(); //
     this.getSelateData();
  ...
  methods: {
      ...
      $.ajax({
        ...
        success: res => {
          ...
          this.upconfig.uploadurl =
            res.baseURL + "BisProjectqualityreport/upload"; //上传地址
        }
      });
    },
    //获取初始化数据
    getInitData(){
      var _this = this;
      var url = "/BisProjectqualityreport/GetInfoById";
      _this.$fetchGet({ url, params: { id: _this.detailData.id } }).then(res => {
        ...
        // _this.dataFrom.dataId = res.data.dataId;
    ...
    submit() {
      ...
      var url = "/BisProjectqualityreport/Update";
