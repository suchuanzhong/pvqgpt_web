  ...
  <div>
    <div class="base-top">
      <el-row :gutter="20">
        ...
        <el-col :span="4" class="base-industrBox" >

            <SubTitle
                    text="产业升级"
                    en="Industrial upgrading"
                    class="inlineBlock active"
            ></SubTitle>
            <span class="more" @click="Industrial">MORE</span>
        
          <div class="evaluations">
            <industrialTextHome
                    v-for="(i, index) in IndustrialList"
                    :key="index"
                    :title="i.title"
                    :imgName="i.imgName"
                     :titleTwo="i.titleTwo"
      ...
      <el-row style="padding-top: 20px;">
        <el-col :span="9">
          ...
          <el-col>
            ...
            <h4 class="tilt_title">基地年发电量排名</h4>
            <echartBarBase
                    ids="yearEnergy"
                    unit="(万kWh)"
                    :theme="['#00a8f6', '#12c9fe']"
        ...
        <el-col :span="10" style="padding-left: 18px">
          ...
          <div style="height:460px;width: 750px">
            <echartBar1
                    ids="bar1"
                    ref="bar1"
                    :data="barData1.data"
        ...
        <el-col :span="4" class="base-evaluation">
...
<script>
  import BasicInfo from "../page/baseInfo";
  import Operation from "../page/operation";
  import AllEvaluation from "../page/allEvaluation";
  import Industrial from "../page/IndustrialUpgrading";
  export default {
    components: {
      BasicInfo,
      Operation,
      ...
      industrialTextHome: resolve => {
        require(["@/components/public/echarts/industrialTextHome.vue"], resolve);
      },
      ...
      return {
        ...
        IndustrialList:[
          ...
          },
          {
            title: "领跑电价",
            titleTwo: "逐年降低",
            imgName: "my-icon-prices",
            bgColor: "elctricityPrices",
          },
        ],
        evalList: [
          {
    ...
    methods: {
      ...
      getMapList() {
        ...
        this.$fetch("/MtrBase/GetBaseMapList").then(res => {
          ...
          // this.$refs.map.stationMarker(this.initMap)
          // this.$refs.map.setMapZoom()
        });
      },
      //运行监测
      operateMonitor() {
...
<style scoped lang="scss">
  ...
  .base-box{
    border: 1px solid #1BAB69;
    /*background: linear-gradient(90deg, #1DA63B, #19B197);*/
    border-radius: 2px;
    margin-right: 30px;
  }
  .base-content {
