            ...
            GetEnterpStation(){
                ...
                this.$fetch("/LtrStation/GetEnterpStation",{
                    ...
                    if (res.code == 1) {
                        ...
                        this.$nextTick(()=>{
                            this.intSeriseData(ionData,this.dataAxis.series)
                            this.$refs.power.initEcharts(this.dataAxis.series)
